...
AGENT_VECTOR_STORE_IDS_ENVS: Mapping[str, str] = {
    ...
    "rag_retrieval_specialist": "KEYSTONE_RAG_RETRIEVAL_SPECIALIST_FILE_SEARCH_VECTOR_STORE_IDS",
...
AGENT_MAX_RESULTS_ENVS: Mapping[str, str] = {
    ...
    "rag_retrieval_specialist": "KEYSTONE_RAG_RETRIEVAL_SPECIALIST_FILE_SEARCH_MAX_NUM_RESULTS",
...
AGENT_INCLUDE_RESULTS_ENVS: Mapping[str, str] = {
    ...
    "rag_retrieval_specialist": "KEYSTONE_RAG_RETRIEVAL_SPECIALIST_FILE_SEARCH_INCLUDE_RESULTS",
