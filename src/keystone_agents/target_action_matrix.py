...
TARGET_ACTION_SCORECARD: tuple[TargetActionCase, ...] = (
    ...
    TargetActionCase(
        ...
        allowed_tool_tier="blocked write plan only",
        approval_gate="scoped Workspace create approval required",
        expected_proof="create request blocked before write",
        fallback_blocker="missing approval and destination",
        artifact_backed=False,
    ...
    TargetActionCase(
        ...
        allowed_tool_tier="schema-first blocked write plan",
        approval_gate="scoped Airtable update approval required",
        expected_proof="update request blocked before write",
