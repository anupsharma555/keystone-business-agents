...
def test_build_sdk_session_from_env_uses_explicit_env(monkeypatch, tmp_path: Path) -> None:
    ...
    def fake_build_sqlite_session(session_id: str, database_path: str) -> object:
        calls.append((session_id, database_path))
        return object()
...
def test_sdk_session_from_args_honors_default_enabled_without_flags(
    ...
    args = Namespace(sdk_session=None, sdk_session_id="", sdk_session_db="")
...
def test_non_chief_ask_can_still_opt_into_session() -> None:
    args = Namespace(sdk_session=True, sdk_session_id="", sdk_session_db="")
