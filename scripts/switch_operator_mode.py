...
MANAGED_KEYS: Final[tuple[str, ...]] = (
    ...
    "KEYSTONE_LIVE_MODEL_MAX_RETRIES",
    "SEARCH_PROVIDER",
    "AUTO_SEND_EMAIL",
)
    ...
    *,
    ...
    if mode == "dry-run":
        return {
            ...
            "KEYSTONE_FIRECRAWL_EXTRACTION_MAX_CALLS_PER_RUN": "0",
            ...
            "KEYSTONE_LIVE_MODEL_MAX_RETRIES": "1",
    ...
    if mode == "live-test":
        return {
            ...
            "KEYSTONE_WEBSITE_EXTRACTOR": "trafilatura",
            "KEYSTONE_WEBSITE_EXTRACTOR_FALLBACK": "crawl4ai,firecrawl",
            "KEYSTONE_FIRECRAWL_EXTRACTION_MAX_CALLS_PER_RUN": "1",
            "SEARXNG_BASE_URL": "http://127.0.0.1:18080",
            "KEYSTONE_SEARXNG_TRANSIENT": "true",
            "KEYSTONE_EXA_SEARCH_FALLBACK": "true",
            "KEYSTONE_EXA_SEARCH_MAX_CALLS_PER_RUN": "2",
